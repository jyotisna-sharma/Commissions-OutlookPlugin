    ...
    public class FileUtility
    {
        ...
        Uri getServerUrl(String path, Boolean appendTrailingSlash)
        {
            ...
            else
            {
                ...
                return new Uri("http://localhost/FileManager" + completePath);
            }
        ...
        public void Upload(String localFilePath, String remoteFilePath, object state)
        {
            try
            {
                ...
                ////http://localhost/FileManager/UploadBatch/Agency1_43.pdf

            }
            catch (System.Exception error)
            {
                //File.Copy(@"C:\Users\Vinod.Yadav\AppData\Local\Temp\Agency1_35.pdf", remoteFilePath);
